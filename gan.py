...
class discriminator(nn.Module):
    def __init__(self):
        ...
        self.down1 = DownBlock(3,16) # (3,256,256) -> (16,128,128)
    ...
    def forward(self, x, style):
        out = self.down1(x, style)
        out = self.down2(out, style)
        out = self.down3(out, style)
        out = self.down4(out, style)
        out = self.down5(out, style)
        out = self.down6(out, style)
