...
class style_mixer(nn.Module):
    def __init__(self):
        ...
        self.conv = nn.Sequential(
            Equal_Conv2d(3, 16, 3,1,1, bias=False),
            nn.LeakyReLU(inplace=True),
            nn.MaxPool2d(kernel_size=2, stride=2),
            Equal_Conv2d(16, 32, 3,1,1, bias=False),
            nn.LeakyReLU(inplace=True),
            nn.MaxPool2d(kernel_size=2, stride=2),
            Equal_Conv2d(32, 64, 3,1,1, bias=False),
            nn.LeakyReLU(inplace=True),
            nn.MaxPool2d(kernel_size=2, stride=2),
            Equal_Conv2d(64, 64, 3,1,1, bias=False),
            nn.LeakyReLU(inplace=True),
            nn.MaxPool2d(kernel_size=2, stride=2),
            Equal_Conv2d(64, 64, 3,1,1, bias=False),
            nn.LeakyReLU(inplace=True),
...
class UpBlock(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.conv1 = Equal_Conv2d(in_channel, in_channel, 3,1,1, bias=False)
        self.conv2 = Equal_Conv2d(in_channel, out_channel, 3,1,1, bias=False)
        
        self.conv3 = Equal_Conv2d(in_channel, out_channel, 1,1,0, bias=False)
...
class RGBBlock(nn.Module):
    def __init__(self, in_channel):
        ...
        self.conv = Equal_Conv2d(in_channel, 3, 3,1,1, bias=True)
...
class DownBlock(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.conv1 = Equal_Conv2d(in_channel, out_channel, 3,1,1, bias=False)
        self.conv2 = Equal_Conv2d(out_channel, out_channel, 3,1,1, bias=False)
...
class Attention(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.conv1 = Equal_Conv2d(in_channel, mid_channel, kernel_size=1, stride=1, padding=0, bias=False)
        self.conv2 = Equal_Conv2d(in_channel, mid_channel, kernel_size=1, stride=1, padding=0, bias=False)
        self.conv3 = Equal_Conv2d(in_channel, mid_channel, kernel_size=1, stride=1, padding=0, bias=False)
        self.conv4 = Equal_Conv2d(mid_channel, out_channel, kernel_size=1, stride=1, padding=0, bias=False)
...
class discriminator(nn.Module):
    def __init__(self):
        ...
        self.fc = nn.Sequential(
            Equal_Linear(512, 256, bias=False),
            nn.LeakyReLU(),
            Equal_Linear(256, 1, bias=False)
            )
